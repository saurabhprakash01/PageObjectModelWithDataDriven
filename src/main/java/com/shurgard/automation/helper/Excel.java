 ...
 * This class will help to read the data from excel file
 */
public class Excel {
	...
	public static void setExcelFileSheet(String sheetName) {
		...
		try {
			...
			FileInputStream ExcelFile = new FileInputStream(
					testDataExcelPath + AutomationFoundation.testDataExcelFileName);
	...
	/***
	 * 
	 * This method gets excel file, row and column number and set a value to that cell.
	 */
